  ...
  return (
    <svg width="24" height="24" fill="none" className={className}>
      ...
      <defs>
        ...
        >
          <stop offset="0.001" stopColor="#FBE18A" />
          <stop offset="0.209" stopColor="#FCBB45" />
          <stop offset="0.377" stopColor="#F75274" />
          <stop offset="0.524" stopColor="#D53692" />
          <stop offset="0.739" stopColor="#8F39CE" />
